...
const status_request = hexStr.slice(42, 44);
const flow = hexStr.slice(44, 52);
const totalizador = hexStr.slice(52, 68);
const statusBomb = hexStr.slice(68, 70);
...
result = {
    ...
    status_request: hexToBoolean(status_request),
    flow: hexToFloat(flow),
    tote: hexToFloat(totalizador),
    status: hexToDecimal(statusBomb)
}
